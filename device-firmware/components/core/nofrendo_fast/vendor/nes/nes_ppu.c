...
bool __attribute__((section(".iram1"))) ppu_enabled(void)
{
...
void __attribute__((section(".iram1"))) ppu_endscanline(int scanline)
{
...
void __attribute__((section(".iram1"))) ppu_scanline(bitmap_t *bmp, int scanline,
                                                      bool draw_flag)
{
   if (scanline < 240)
   {
